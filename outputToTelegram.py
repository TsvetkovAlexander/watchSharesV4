...
async def print_anomal_volume(client, ticker, marketdata,
    ...
    # print(todayOpenPrice.candles[0], "todayOpenPrice.candles[0].close")
    ...
    if total_volume != 0:
        ...
        print(arr_times_direction,  'arr_times_direction', '\n',
                              arr_times_figi_volume, 'arr_times_figi_volume','\n',
                              old_arr_times_direction,'old_arr_times_direction','\n',
